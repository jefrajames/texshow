package org.jefrajames.merchant.boundary;
...
import org.jefrajames.merchant.control.MerchantService;
import org.jefrajames.merchant.entity.Merchant;
import org.jefrajames.score.control.ScoreService;
...
public class MerchantGraphQLApi {
    ...
    public List<Score> getScores(@Source Merchant merchant) {
        log.warning("TexShow demo => calling Payment Score service for merchant " + merchant.id);
